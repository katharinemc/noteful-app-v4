...
describe.only('Noteful API - Notes', function () {
  ...
  describe.skip('GET /api/notes', function () {
      ...
      return Promise.all([
        ...
        .then(([data, res]) => {
          ...
          res.body.forEach(function (item) {
            ...
            expect(item).to.have.keys('id', 'title', 'content', 'userId', 'createdAt', 'updatedAt', 'folderId', 'tags');
          });
        });
    });
    ...
    it('should return correct search results for a searchTerm query', function () {
      ...
      return Promise.all([
        Note.find({ $and: [ {title: { $regex: searchTerm }}, {userId: user.id} ] }),
    ...
    it('should return correct note', function () {
      ...
      return Note.findOne({userId: user.id})
        ...
        .then((res) => {
          ...
          expect(res.body).to.have.keys('id', 'title', 'content', 'userId', 'createdAt', 'updatedAt', 'folderId', 'tags');
    ...
    it('should update the note when provided proper valid data', function () {
      ...
      return Note.findOne({userId: user.id})
        ...
        .then(function (res) {
          ...
          expect(res).to.be.json;
          expect(res.body).to.be.a('object');
          expect(res.body).to.have.keys('id', 'title', 'userId', 'content', 'createdAt', 'updatedAt', 'folderId', 'tags');
